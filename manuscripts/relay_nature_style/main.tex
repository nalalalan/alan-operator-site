...
The returned artifact is a follow-up packet. Figure~\ref{fig:sample_packet} shows the sample preview used on the product page. This matters because the experimental offer is not a vague artificial-intelligence claim; it is a concrete promise that rough sales-call notes can be converted into a recap, follow-up draft, next-step table, open questions, and CRM-ready update.

\begin{figure}[tbp]
    \centering
    \includegraphics[width=0.82\textwidth]{figures/relay-sample-preview.png}
\caption{Relay sample-packet preview shown to buyers. The revised sample makes the value proposition visible as a before--after transformation: rough call note received, finished handoff returned.}
